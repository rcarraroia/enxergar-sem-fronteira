    ...
    return useQuery({
        ...
        queryFn: async () => {
            try {
                ...
                // Top cidades (sem usar query que causa erro)
...
// Hook para criar promoter (versão simplificada)
    ...
    return useMutation({
        mutationFn: async (data: PromoterCreation) => {
            try {
                ...
                // O promoter poderá usar "Esqueci minha senha" para definir senha
        ...
        mutationFn: async ({ id, data }: { id: string, data: Partial<PromoterV2> }) => {
            try {
                ...
                if (data.asaas_wallet_id !== undefined) {
                    updateData.asaas_wallet_id = data.asaas_wallet_id
                }

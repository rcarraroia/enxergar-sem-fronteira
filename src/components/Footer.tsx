        ...
        <div className="py-16 grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-xl font-bold">Visão Itinerante</h3>
            ...
            <div className="flex space-x-3">
              {socialLinks.map((social, index) => (
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="w-10 h-10 p-0 border-background/20 hover:bg-primary hover:border-primary"
                  asChild
                >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-muted opacity-80">contato@visaoitinerante.org.br</span>
              </div>
              <div className="flex items-center space-x-3">

        ...
        <div className="mt-20 text-center animate-fade-in">
          <Card className="p-8 medical-card">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-secondary/10 rounded-lg flex items-center justify-center mx-auto mb-2">
                  <Shield className="h-8 w-8 text-secondary" />
                </div>
                <p className="text-sm font-medium text-foreground">Renum</p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-foreground">Ministério da Saúde</p>
              </div>
            </div>
          </Card>
        </div>
